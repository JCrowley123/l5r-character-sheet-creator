...
| Monks, no UI | `PART E — Feature 1 Monks & Kiho` | `04cd0f29e4331bd5` |
| **This — monks + UI** | `PART E — Feature 1.1 …` | `fffac9185482bb6f` |
...
- **528 assertions across nine suites, 0 failures** — the full monk/Kiho regression set
