# -*- coding: utf-8 -*-
"""
PART D — FEATURE 3.1: the roll-button d10 at its largest safe size.

Feature 3 with one changed value in dice-icons.css. Nothing else differs.
...
TRUNK_DIR = os.path.join(HERE, os.pardir, "PART E — Feature 1 Monks & Kiho")

# READ ONLY — never written to, never moved.
SRC = os.path.join(TRUNK_DIR, "l5r-character-sheet part E feature 1 MONKS.html")
# Every generated file lands beside this script.
DST = os.path.join(HERE, "l5r-character-sheet part E feature 1.1 MONKS UI.html")
...
# ----------------------------------------------------------------- anchors
CSS_INSERT   = 1352            # the sheet's own "@media print{"
BODY_OPEN    = 1426
WRAP_OPEN    = 1427
TOPBAR_A, TOPBAR_B = 1429, 1455   # titlebar + toolbar
TAIL_A             = 1772         # floating dice button onwards
FOOTER             = 2113
WRAP_CLOSE         = 2114
SCRIPT_OPEN        = 2116
...
SECTIONS = [
    (1457, 1458, 1487, "Clan &amp; School",  None),
    (1489, 1490, 1585, "Identity",           None),
    (1587, 1588, 1592, "Rings &amp; Traits", None),
    (1594, 1595, 1613, "Skills",             None),
    (1615, 1616, 1633, "Adv &amp; Disadv",   None),
    (1635, 1636, 1647, "Techniques",         None),
    (1649, 1650, 1654, "Spell Slots",        "#spellSlotsSection"),
    (1656, 1657, 1737, "Combat",             None),
    (1739, 1740, 1759, "Equipment",          None),
    (1761, 1762, 1770, "Background",         None),
]
