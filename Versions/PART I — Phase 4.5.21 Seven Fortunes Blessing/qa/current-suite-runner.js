...
const previous = path.resolve(__dirname, '../../PART I — Phase 4.5.20 Void Versatility/qa/current-suite-runner.js');
let passed = 0, total = 0, failures = 0;
for (const [file, pattern] of [[previous, /COMBINED (\d+)\/(\d+) checks passed across every retained suite plus Void Versatility/],
