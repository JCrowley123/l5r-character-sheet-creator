...
(function runP12Harness(){
  ...
  // =====================================================================
  eq('P2','M1','Registry starts empty',T.PREROLL_MODIFIER_REGISTRY.length,0);
  eq('P2','M2','Empty registry yields no modifiers',T.getPreRollModifiers(T.makeRollContext('skill')),[]);
  ...
  // =====================================================================
  cleanup();
  eq('P2','N1','Registry empty again',T.PREROLL_MODIFIER_REGISTRY.length,0);
  T.rollSkill('Kenjutsu','Agility',7);
