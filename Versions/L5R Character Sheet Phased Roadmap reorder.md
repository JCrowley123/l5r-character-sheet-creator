...
| 11 | K | Characters List, Creation Wizard & Save Model | **First stage built, iPhone list view confirmed; 11.2 wizard first stage built** | Delivered in stages, approved 24 September 2026: the Characters list, save model and share-aware JSON first; the Creation Wizard as **Phase 11.2** (full screens, the owner's choice; Name to Review built, Skills and Advantages next); Export to PDF split out as **Phase 11.1**. See `Versions/PART K — Phase 11 Characters List and Save Model/README.md` |
