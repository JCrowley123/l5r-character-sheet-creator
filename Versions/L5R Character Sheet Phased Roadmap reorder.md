...
| 12 | K | Play Mode / Management Mode Split | **Audit done** (25 September 2026); build next | Rulings of 25 September are recorded in the phase section below. The audit (`Versions/PART K — Phase 12 Play and Management Modes Audit/AUDIT.md`) classifies every control on all ten tabs, recommends one capture-phase gate with a selector registry, estimates about 17–27% over three stages, and lists four rulings needed before stage 12 |
...
> - **Audit (25 September):** `Versions/PART K — Phase 12 Play and Management Modes Audit/AUDIT.md`. Four rulings are open there before stage 12.
